...
# 使用cost-sensitive 实现Y重建
def BiasMC(X, Y, U_init, V_init, W_init, H_init, fea_loc, label_loc, alpha, lambda0, lambda1,
...
if __name__ == '__main__':
    ...
    U,V,W,H= BiasMC(train_data,train_label_masked,U_init,V_init,W_init,H_init,fea_loc,label_loc,
